...
#define configTOTAL_HEAP_SIZE           ((size_t)(configBASE_HEAP_SIZE +	\
												configHEAP_EXTRA_LOG +	\
												configHEAP_EXTRA_ANALIZER +	\
												configHEAP_EXTRA_SCOPORT +	\
													(configBTTASK_STACK_SIZE +	\
													configMINIMAL_STACK_SIZE + 	\
													configAUDIO_TASK_STACK_SIZE +	\
													configANALIZER_TASK_STACK_SIZE +	\
													configSCOPORT_TASK_STACK_SIZE) * sizeof(portSTACK_TYPE)))
