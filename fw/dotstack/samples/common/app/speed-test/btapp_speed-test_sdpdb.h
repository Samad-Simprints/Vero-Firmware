...
// It was generated by the DotStack SDP Compiler
// from the following XML file:
//
//    btapp_speed-test_sdpdb.xml
//
// -------------------------------------------------------------------
...
extern const bt_byte sdp_db_speed_test[466];
extern const bt_uint sdp_db_speed_test_len;


#else

const bt_byte sdp_db_speed_test[466] = {
    // Number of records
    '\x00','\x03',
...
const bt_uint sdp_db_speed_test_len = 466;
