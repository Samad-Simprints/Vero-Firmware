...
#define CDC_HOST_CORENUM					1
#define CDC_DEVICE_CORENUM					0
...
/* Type Defines: */
	...
	typedef struct
	{
		...
		USB_Descriptor_Interface_Association_t   CDC_IF_Assoc;
		USB_Descriptor_Interface_t               CDC_CCI_Interface;
		USB_CDC_Descriptor_FunctionalHeader_t    CDC_Functional_Header;
		USB_CDC_Descriptor_CallManagement_t      CDC_Call_Management;
	  ...
	  //uint8_t                                  abStringDescriptors[];            // variable length (currently 131)
...
void EVENT_USB_Device_CDC_ConfigurationChanged(void);
void EVENT_USB_Host_CDC_ConfigurationChanged(void);

void EVENT_USB_Device_CDC_ControlRequest(void);
void EVENT_USB_Host_CDC_ControlRequest(void);

void CDCDeviceSetupHardware(void);
void CDCDeviceShutdownHardware(void);
void CDCHostSetupHardware(void);
void CDCHostShutdownHardware(void);

void CDCDeviceSendBytes ( USB_ClassInfo_CDC_Device_t* const CDCInterfaceInfo, uint8_t* acDataBytes, int iLen);
void CDCHostSendBytes ( USB_ClassInfo_CDC_Host_t* const CDCInterfaceInfo, uint8_t* acDataBytes, int iLen);

extern USB_ClassInfo_CDC_Device_t CDC_Device_Interface;
extern USB_ClassInfo_CDC_Host_t CDC_Host_Interface;
